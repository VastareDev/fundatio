 ...
 * @category Constants
 */
export declare const H5_TAG: "h5";
/**
 * A CSS selector targeting h5 elements.
 *
 * @category Constants
 */
export declare const H5_SELECTOR = "h5";
/**
 ...
 * @category DOM
 */
export declare function createH5(text?: string, attrs?: H5Attrs): ElementOf<typeof H5_TAG>;
/**
 ...
 */
export declare function enhanceH5s(root?: ParentNode): void;

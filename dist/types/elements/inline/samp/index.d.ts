 ...
 * @category Constants
 */
export declare const SAMP_TAG: "samp";
/**
 * A CSS selector targeting samp elements.
 *
 * @category Constants
 */
export declare const SAMP_SELECTOR = "samp";
/**
 ...
 * @category DOM
 */
export declare function createSamp(text?: string, attrs?: SampAttrs): ElementOf<typeof SAMP_TAG>;
/**
 ...
 */
export declare function enhanceSamps(root?: ParentNode): void;

 ...
 * @category Constants
 */
export declare const TFOOT_TAG: "tfoot";
/**
 * A CSS selector targeting tfoot elements.
 *
 * @category Constants
 */
export declare const TFOOT_SELECTOR = "tfoot";
/**
 ...
 * @category DOM
 */
export declare function createTfoot(attrs?: TfootAttrs): ElementOf<typeof TFOOT_TAG>;
/**
 ...
 */
export declare function enhanceTfoots(root?: ParentNode): void;

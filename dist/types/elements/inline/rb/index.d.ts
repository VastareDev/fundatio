/**
 * Sol Design Foundation: rb element helpers.
 *
 * @remarks
 ...
 *
 * Implementation note:
 * - In HTML source, `</rb>` may be omitted in certain sequences, but Sol creates
 ...
 * @category Constants
 */
export declare const RB_TAG: "rb";
/**
 * A CSS selector targeting rb elements.
 *
 * @category Constants
 */
export declare const RB_SELECTOR = "rb";
/**
 ...
 * @example
 * ```ts
 * import { createRb } from "@lnpg/sol/elements/inline/rb";
 *
 ...
 * @category DOM
 */
export declare function createRb(text?: string, attrs?: RbAttrs): HTMLElement;
/**
 ...
 */
export declare function enhanceRbs(root?: ParentNode): void;

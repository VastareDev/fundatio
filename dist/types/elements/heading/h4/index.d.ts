 ...
 * @category Constants
 */
export declare const H4_TAG: "h4";
/**
 * A CSS selector targeting `<h4>` elements.
 *
 * @category Constants
 */
export declare const H4_SELECTOR = "h4";
/**
 ...
 * @category DOM
 */
export declare function createH4(text?: string, attrs?: H4Attrs): ElementOf<typeof H4_TAG>;
/**
 ...
 */
export declare function enhanceH4s(root?: ParentNode): void;

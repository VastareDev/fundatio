 ...
 * @category Constants
 */
export declare const DATALIST_TAG: "datalist";
/**
 * A CSS selector targeting datalist elements.
 *
 * @category Constants
 */
export declare const DATALIST_SELECTOR = "datalist";
/**
 ...
 * @category DOM
 */
export declare function createDatalist(text?: string, attrs?: DatalistAttrs): ElementOf<typeof DATALIST_TAG>;
/**
 ...
 */
export declare function enhanceDatalists(root?: ParentNode): void;

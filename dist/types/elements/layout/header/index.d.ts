 ...
 * @category Constants
 */
export declare const HEADER_TAG: "header";
/**
 * A CSS selector targeting header elements.
 *
 * @category Constants
 */
export declare const HEADER_SELECTOR = "header";
/**
 ...
 * @category DOM
 */
export declare function createHeader(text?: string, attrs?: HeaderAttrs): ElementOf<typeof HEADER_TAG>;
/**
 ...
 */
export declare function enhanceHeaders(root?: ParentNode): void;

 ...
 * @category Constants
 */
export declare const KBD_TAG: "kbd";
/**
 * A CSS selector targeting kbd elements.
 *
 * @category Constants
 */
export declare const KBD_SELECTOR = "kbd";
/**
 ...
 * @category DOM
 */
export declare function createKbd(text?: string, attrs?: KbdAttrs): ElementOf<typeof KBD_TAG>;
/**
 ...
 */
export declare function enhanceKbds(root?: ParentNode): void;

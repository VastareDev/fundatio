 ...
 * @category Constants
 */
export declare const DL_TAG: "dl";
/**
 * A CSS selector targeting dl elements.
 *
 * @category Constants
 */
export declare const DL_SELECTOR = "dl";
/**
 ...
 * @category DOM
 */
export declare function createDl(text?: string, attrs?: DlAttrs): ElementOf<typeof DL_TAG>;
/**
 ...
 */
export declare function enhanceDls(root?: ParentNode): void;

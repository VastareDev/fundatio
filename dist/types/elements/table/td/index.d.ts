 ...
 * @category Constants
 */
export declare const TD_TAG: "td";
/**
 * A CSS selector targeting td elements.
 *
 * @category Constants
 */
export declare const TD_SELECTOR = "td";
/**
 ...
 * @category DOM
 */
export declare function createTd(text?: string, attrs?: TdAttrs): ElementOf<typeof TD_TAG>;
/**
 ...
 */
export declare function enhanceTds(root?: ParentNode): void;

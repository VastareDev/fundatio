/**
 * Sol Design Foundation: Code element helpers.
 *
 * @remarks
 ...
 * @category Constants
 */
export declare const CODE_TAG: "code";
/**
 * A CSS selector targeting code elements.
 *
 * @category Constants
 */
export declare const CODE_SELECTOR = "code";
/**
 ...
 * @example
 * ```ts
 * import { createCode } from "@lnpg/sol/elements/inline/code";
 *
 ...
 * @category DOM
 */
export declare function createCode(text?: string, attrs?: CodeAttrs): ElementOf<typeof CODE_TAG>;
/**
 ...
 */
export declare function enhanceCodes(root?: ParentNode): void;

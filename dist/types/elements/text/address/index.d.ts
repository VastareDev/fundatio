/**
 * Sol Design Foundation: Address (`address`) element helpers.
 *
 * @remarks
 ...
 * @category Constants
 */
export declare const ADDRESS_TAG: "address";
/**
 * A CSS selector targeting address elements.
 *
 * @category Constants
 */
export declare const ADDRESS_SELECTOR = "address";
/**
 ...
 * @example
 * ```ts
 * import { createAddress } from "@lnpg/sol/elements/text/address";
 *
 ...
 * @category DOM
 */
export declare function createAddress(text?: string, attrs?: AddressAttrs): ElementOf<typeof ADDRESS_TAG>;
/**
 ...
 */
export declare function enhanceAddresses(root?: ParentNode): void;
